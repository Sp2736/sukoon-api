      ...
      <div className="bg-white rounded-xl border border-stone-200 shadow-sm overflow-hidden flex flex-col">
        {testimonials.length === 0 ? (
          <div className="py-24 text-center px-6">
            ...
            <Link
              href="/admin/testimonials/new"
              className="inline-flex items-center text-brand font-bold hover:underline gap-2 text-sm"
            >
              Create First Review →
            </Link>
          </div>
            ...
            <div className="overflow-x-auto flex-1">
              <table className="w-full text-left border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-stone-100">
                  {paginatedTestimonials.map((t: any) => (
                    <tr
                      key={t.id}
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end gap-3 items-center">
                          <button className="text-stone-400 hover:text-brand text-xs font-bold transition-colors">
                            Edit
                          </button>
